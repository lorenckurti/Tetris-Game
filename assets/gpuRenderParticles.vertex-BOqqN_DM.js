import{t as e}from"./shaderStore-D-XQlhUT.js";import{F as t,H as n,M as r,N as i,P as a,V as o}from"./index-DOzZCtXz.js";var s=`gpuRenderParticlesVertexShader`,c=`uniform view: mat4x4f;uniform projection: mat4x4f;uniform translationPivot: vec2f;uniform worldOffset: vec3f;
#ifdef LOCAL
...
`;e.ShadersStoreWGSL[s]||(e.ShadersStoreWGSL[s]=c);var l=[n,t,a,o,i,r];for(let t of l)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);var u={name:s,shader:c};export{u as gpuRenderParticlesVertexShaderWGSL};